 ...
 *      @class Tour
 *      @description Classe pour gérer une Tour
 *      
...
public class Tour extends Piece
{
	...
	////{
		...
		////{
			...
			public Tour(int [] coord)
			{
				super(coord);
			}
			
			public Tour(int abscisse, int ordonnee)
			{
		...
		////{
			...
			{
				return ((to[0] == from[0] || to[1] == from[1])); // On teste si une des coordonnée est identique
			}
