 ...
 *      @class Fou
 *      @description Classe pour gérer un Fou
 *      
...
public class Fou extends Piece
{
	...
	////{
		...
		////{
			...
			public Fou(int [] coord)
			{
				super(coord);
			}
			
			public Fou(int abscisse, int ordonnee)
			{
		...
		////{
			...
			{
				return (!(Math.abs(to[0] - from[0]) != Math.abs(to[1] - from[1]))); // On teste dx/dy
			}
